package sample.compiler.core.run;

import javafx.scene.control.TextArea;
import sample.compiler.core.code.analyser.FourItem;
import sample.compiler.core.code.analyser.FuncInfo;
import sample.compiler.core.code.analyser.VarInfo;
import sample.compiler.core.code.interpreter.ASCII;
import sample.compiler.core.code.interpreter.Activity;
...
public class NewInterpreter {
    ...
    public NewInterpreter (TextArea text) {
        new ASCII();
        this.textArea = text;
    }
